...
In these tests, two kinds of THGEM were employed: in the first one, referred to as FULL THGEM~\ref{fig:full_thgem}, the holes are uniformly distributed over the active surface; in the second one, called ROW THGEM, the holes are arranged in five rows.
In the FULL THGEM there are 143 rows of holes in horizontal and in vertical direction~\ref{fig:full_thgem_holes}.
