...
A series of systematic measurements were conducted to study the effects of the \Vind{} variation on the measured currents.
These measurements have been done at three different pressure (P) and setting suitable values of \Vthgem{} and \Vdrift.
...
\begin{figure}[htb]
	...
	\caption{Currents measured during the scan on the induction voltage at 30~mbar and with \Vthgem{}~=~220~V.}
...
\begin{figure}[!htb]
	\centering
	\subfigure[]{ \label{fig:induction_FULLTHGEM_30mbar_other_VTHGEM_a} \includegraphics[width=\textwidth]{Immagini/inductionScan_THGEM10_30mbar_bis.pdf}}
	\subfigure[]{ 	\label{fig:induction_FULLTHGEM_30mbar_other_VTHGEM_b} \includegraphics[width=\textwidth]{Immagini/inductionScan_THGEM10_30mbar_tris.pdf}}
	\caption{Caption-figura-complessiva}
	\label{fig:induction_FULLTHGEM_30mbar_other_VTHGEM}
\end{figure}
Comparing the two figures, The magnitude of the measured currents increases with increasing \Vthgem, because 
