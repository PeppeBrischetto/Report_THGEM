void plotTable_IBF_Drift()
{
   ...
   in1.open("driftScan_THGEM10_400pA_10mbar.txt");
   ...
   in2.open("driftScan_THGEM10_60pA_10mbar.txt");
   ...
   in4.open("driftScan_THGEM10_10mbar.txt");
   ...
   in5.open("driftScan_THGEM10_10mbar_bis.txt");
   ...
   in6.open("driftScan_THGEM10_60pA_10mbar_onepoint_average.txt");
   ...
   in8.open("driftScan_THGEM10_1000pA_10mbar_onepoint_average.txt");
  ...
  leg->AddEntry(gr6,"400 pA, V_{TH}=160V", "P");
  leg->AddEntry(gr7,"60 pA, V_{TH}=160V", "P");
  leg->AddEntry(gr8,"#alpha, V_{TH}=160V, 2020/02/20", "P");
  leg->AddEntry(gr16,"#alpha, V_{TH}=160V, 2020/03/02", "P");           
  leg->AddEntry(gr9,"#alpha, V_{TH}=190V", "P");
  leg->AddEntry(gr10,"#alpha, V_{TH}=170V", "P");
  leg->AddEntry(gr11,"60 pA, V_{TH}=150V", "P");
  leg->AddEntry(gr12,"400 pA, V_{TH}=150V", "P");
  leg->AddEntry(gr13,"1 nA, V_{TH}=150V", "P"); 
  ...
  TH2F *bga=new TH2F("bga1","",1000,0,1200,1000,0,100);
   bga->SetStats(0);
